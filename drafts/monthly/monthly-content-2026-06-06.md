# Monthly Content Rollup — 2026-06-06

> **DRAFT ONLY — do not publish.** Generated by `scripts/content-engine.sh`
> on 2026-06-06 from 1 commit(s) in 2026-05-07 .. 2026-06-06.
...
1. docs(reference): add skill-change-eval-template (Phase 1 v0.5.x port) — <why it mattered>
...
- Commits this window: 1 [observed]
- Contributors: Prasith Govin [observed]
...
- Window: 2026-05-07 .. 2026-06-06 (30 days)
- Commits: 1
- Contributors: Prasith Govin
